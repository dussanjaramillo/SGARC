...
{
    public partial class VisorObligacion : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = "Paginas/CostasProcesales/Obligacion/ObligacionXIdentificacion.rdl";
                ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("DataSet1", "SdsBuscarObligaciones"));
