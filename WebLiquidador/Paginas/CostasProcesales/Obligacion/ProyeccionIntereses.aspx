<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCpp.Master" AutoEventWireup="true" CodeBehind="ProyeccionIntereses.aspx.cs" Inherits="WebLiquidador.Paginas.CostasProcesales.Obligacion.ProyeccionIntereses" %>
...
<table class="auto-style10">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnImprimir" runat="server" OnClick="btnImprimir_Click" Text="Imprimir" Enabled="False" Width="170px" />
    ...
    <table class="auto-style12">
        <tr>
            <td>
                <asp:GridView ID="grvObligaciones" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="False" OnSelectedIndexChanged="grvObligaciones_SelectedIndexChanged" Width="1234px" AllowPaging="True" AllowSorting="True" DataSourceID="SdsObligacionXDeudor" PageSize="5" OnDataBound="grvObligaciones_DataBound">
    ...
    <table class="auto-style13">
        <tr>
            <td colspan="7" style="background-color: #6E8A34">&nbsp;</td>
        </tr>
        <tr>
            <td>Saldo - Obligación</td>
            <td>Fecha Inicial</td>
            <td>Fecha Final</td>
            <td>Numero Días</td>
            <td>Tasa Anual</td>
            <td>Intereses</td>
            <td>Total Cancelación</td>
        </tr>
        <tr>
            <td><asp:TextBox ID="txtSaldoCapital" runat="server" MaxLength="10" Enabled="False" Font-Bold="True" ForeColor="Maroon" Width="110px" ></asp:TextBox>
            ...
            <td>
                <asp:TextBox ID="txtFechaInicial" runat="server" MaxLength="10" ReadOnly="True" Enabled="False" Font-Bold="True" ForeColor="Maroon" Width="110px"></asp:TextBox>
            </td>
            <td>
                <asp:TextBox ID="txtFechaFinal" runat="server" MaxLength="10" AutoPostBack="True" OnTextChanged="txtFechaFinal_TextChanged" BackColor="#FFFFCC" Font-Bold="True" ForeColor="#003300" Width="110px"></asp:TextBox>
                <Ajax:CalendarExtender ID="txtFechaFinal_CalendarExtender" runat="server" BehaviorID="txtFechaFinal_CalendarExtender" TargetControlID="txtFechaFinal" />
            </td>
            <td>
                <asp:TextBox ID="txtNumeroDias" runat="server" Font-Bold="True" ForeColor="Maroon" Enabled="False" Width="110px"></asp:TextBox>
            </td>
            <td>
                <asp:TextBox ID="txtTasa" runat="server" MaxLength="5" Enabled="False" Font-Bold="True" ForeColor="Maroon" Width="110px" ></asp:TextBox>
            ...
            <td>
                <asp:TextBox ID="txtIntereses" runat="server" Enabled="False" Font-Bold="True" ForeColor="Maroon" Width="110px"></asp:TextBox>
            </td>
            <td>
                <asp:TextBox ID="txtTotalCancelacion" runat="server" Enabled="False" Font-Bold="True" ForeColor="Maroon" Width="110px"></asp:TextBox>
            </td>
        </tr>
        </table>
    <table class="auto-style11">
        <tr>
            ...
            <td>
                <asp:HiddenField ID="hfTasaInteres" runat="server" />
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td>
                <asp:HiddenField ID="hfVigenciaMaxima" runat="server" />
            </td>
            <td>
                &nbsp;</td>
            <td>
