<%@ Page Title="Control Cargue de Pagos" Language="C#" MasterPageFile="~/SiteCpp.Master" AutoEventWireup="true" CodeBehind="ControlCarguePagos.aspx.cs" Inherits="WebLiquidador.Paginas.CostasProcesales.Pagos.ControlCarguePagos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="auto-style8">
        <tr>
            <td><h2>Control Cargue de Pagos</h2></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <asp:SqlDataSource ID="SdsControlCarguePagos" runat="server" ConnectionString="<%$ ConnectionStrings:CentroFormacion %>" SelectCommand="[CostasProcesales].[Usp_BuscarControlPagosCostasProcesales]" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
            </td>
        </tr>
    </table>
</asp:Content>
