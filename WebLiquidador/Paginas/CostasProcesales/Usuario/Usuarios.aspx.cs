...
namespace WebLiquidador.Paginas.CostasProcesales.Usuario
{
    public partial class Usuarios : System.Web.UI.Page
    {
            ...
            else
            {
                ...
                using (SqlConnection con = new SqlConnection(CadenaConexion))
                {
                    try
                    {
                        ...
                        mensaje = "Sr(a) " + txtNombreUsuario.Text.ToString().Trim() + "; Bienvenido(a) al Sistema Liquidador Costas Procesales - Sena, su usuario es: "
                                            + txtCodigoUsuario.Text.ToString().Trim() + " y su clave del sistema es: " + hfClaveUSR.Value.ToString()
                                            + ". Para tal efecto usted debe ingresar a la página https://sgarc.sena.edu.co/Inicio.aspx, para continuar con el proceso de cambio de clave del usuario. Recuerde que el Usuario y la Clave son intransferibles. Después de 31 días de inactividad en el Sistema Liquidador Costas Procesales - Sena, su Usuario será Inactivado. <br /> <br />  <br />  <br /> Cordial Saludo, <br /> <br /> <b>Sistema Liquidador Costas Procesales - Sena </b>";
                        asunto = "Nuevo Usuario y clave acceso - Sistema Liquidador Costas Procesales - Sena";
                        archivo = Server.MapPath(@"\Imagenes\AcercaCostas.pdf");
        ...
        {
            Response.Redirect("~/Paginas/CostasProcesales/Usuario/Usuarios.aspx", false);
        }
