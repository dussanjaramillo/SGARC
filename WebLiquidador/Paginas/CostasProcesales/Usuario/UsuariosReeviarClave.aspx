<%@ Page Title="Reenvío de Clave" Language="C#" MasterPageFile="~/SiteCpp.Master" AutoEventWireup="true" CodeBehind="UsuariosReeviarClave.aspx.cs" Inherits="WebLiquidador.Paginas.CostasProcesales.Usuario.UsuariosReeviarClave" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="auto-style8">
        <tr>
            <td colspan="6" style="background-color: #5C6E3E">
        ...
        <tr>
            <td colspan="6" style="background-color: #5C6E3E">&nbsp;</td>
        </tr>
        <tr>
    ...
    <table align="center" class="auto-style1" style="width: 97%">
        <tr>
            <td class="auto-style12">
                <asp:SqlDataSource ID="SdsUsuariosTodos" runat="server" ConnectionString="<%$ ConnectionStrings:LiquidadorConnectionString %>" SelectCommand="[dbo].[Usp_UsuarioBuscarXIdRol]" SelectCommandType="StoredProcedure">
                    <SelectParameters>
