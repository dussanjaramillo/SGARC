<%@ Page Title="Usuario" Language="C#" MasterPageFile="~/SiteCpp.Master" AutoEventWireup="true" CodeBehind="Usuarios.aspx.cs" Inherits="WebLiquidador.Paginas.CostasProcesales.Usuario.Usuarios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <table class="auto-style1" style="width: 85%">
                    <tr>
                        <td colspan="8" style="background-color: #5C6E3E">
