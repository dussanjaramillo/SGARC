...
namespace WebLiquidador.Paginas.CostasProcesales.Usuario
{
    public partial class UsuariosReeviarClave : System.Web.UI.Page
    {
                ...
                try
                {
                    ...
                    if (reader.HasRows)
                    {
                        while (reader.Read())
                        {
                            ...
                            if (reader[7].ToString() != "2")
                            {
                                btnGuardar.Enabled = false;
                                Alerta("Este Usuario No es de Costas Procesales");
                                return;
                            }
                            txtCodigoUsuario.Focus();
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(CadenaConexion))
            {
                try
                {
                    ...
                    var mensaje = "Sr(a) " + txtNombreUsuario.Text.ToString().Trim() + "; Bienvenido(a) nuevamente al Sistema Liquidador de Costas Procesales, su clave del sistema es: "
                                           ...
                                           "<br /> Cordial Saludo, <br /> <br /> <b>Sistema Liquidador de Costas Procesales</b>";

                    var asunto = "Reactivación de Usuario y/o Reenvío Clave Acceso - Sistema Liquidador de Costas Procesales";
                    bool importante = true;

                    var archivo = Server.MapPath(@"\Imagenes\AcercaCostas.pdf");
        ...
        {
            Response.Redirect("~/Paginas/CostasProcesales/Usuario/UsuariosReeviarClave.aspx", false);
        }
