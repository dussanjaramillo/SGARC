...
{
    public partial class ObligacionesTodas : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = "Paginas/CostasProcesales/Reportes/ObligacionesTodas.rdl";
                ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("DataSet1", "SdsBuscarObligacionTodas"));
