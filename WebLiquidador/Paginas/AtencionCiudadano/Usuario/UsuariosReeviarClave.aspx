<%@ Page Title="Reenvío de Clave" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UsuariosReeviarClave.aspx.cs" Inherits="WebLiquidador.Paginas.AtencionCiudadano.Usuario.UsuariosReeviarClave" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">

</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                <h2>Reenvío de Clave</h2>
                <table class="auto-style1" style="width: 65%">
                    <tr>
                    ...
                    <tr>
                        <td class="auto-style3">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCodigoUsuario" ErrorMessage="Requerido" ForeColor="Maroon" Font-Bold="True" ValidationGroup="btnGuardar"></asp:RequiredFieldValidator>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtCodigoUsuario" ErrorMessage="Requerido" ForeColor="Maroon" Font-Bold="True" ValidationGroup="btnBuscar"></asp:RequiredFieldValidator>
                        </td>
