...
namespace WebLiquidador.Paginas.AtencionCiudadano.Usuario
{
    public partial class Usuarios : System.Web.UI.Page
    {
            ...
            else
            {
                ...
                using (SqlConnection con = new SqlConnection(CadenaConexion))
                {
                    try
                    {
                        ...
                        if (ddlCentroFormacion.SelectedValue == "-1")
                        {
                            mensaje = "Sr(a) " + txtNombreUsuario.Text.ToString().Trim() 
                                + "; Bienvenido al Sistema de Gestión de Atención al Ciudadano - Recaudo y Cartera, su usuario es: " + txtCodigoUsuario.Text.ToString().Trim() 
                                + " y su clave del sistema es: " + hfClaveUSR.Value.ToString() 
                                + ". Para tal efecto usted debe ingresar a la página https://sgarc.sena.edu.co/Inicio.aspx, para continuar con el proceso de cambio de clave del usuario. Recuerde el Usuario y la Clave son intransferibles, la clave debe tener mínimo 7 caracteres, se recomienda usar la misma clave de Red."
                                + "<br /> <br /> Cordial Saludo, <br /> <br /> <b>Sistema de Gestión de Atención al Ciudadano - Recaudo y Cartera </b>";
                            asunto = "Nuevo Usuario y clave acceso - Sistema de Gestión de Atención al Ciudadano - Recaudo y Cartera";
                            archivo = Server.MapPath(@"\Imagenes\Acercade.pdf");
                        }
                        else
                        {
                            mensaje = "Sr(a) " + txtNombreUsuario.Text.ToString().Trim() 
                                + "; Bienvenido al Sistema Nacional de Producción de Centros Formación, su usuario es: " + txtCodigoUsuario.Text.ToString().Trim() 
                                + " y su clave del sistema es: " + hfClaveUSR.Value.ToString() 
                                + ". Para tal efecto usted debe ingresar a la página https://sgarc.sena.edu.co/Inicio.aspx, para continuar con el proceso de cambio de clave del usuario. Recuerde el Usuario y la Clave son intransferibles, la clave debe tener mínimo 7 caracteres, se recomienda usar la misma clave de Red."
                                + " <br /> <br /> Cordial Saludo, <br /> <br /> <b>Sistema Nacional de Producción de Centros Formación </b>";
                            asunto = "Nuevo Usuario y clave acceso - Sistema Nacional de Producción de Centros Formación";
                            archivo = Server.MapPath(@"\Imagenes\AcercadeCentrosFormacion.pdf");
                        }
        ...
        {
            Response.Redirect("~/Paginas/Usuario/Usuarios.aspx", false);
        }
        ...
        {
            Response.Redirect("~/Reportes/VisorUsuario.aspx", false);
        }
