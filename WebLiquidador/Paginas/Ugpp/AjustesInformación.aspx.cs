...
{
    public partial class AjustesInformación : System.Web.UI.Page
    {
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            try
            {
                string PathArchivo = "SENA_PASENA_1005_" + txtFechaInicial.Text.ToString() + "_" + txtFechaFinal.Text.ToString() + "_AjusteInformacion.txt";
                //string PathArchivo = "5000_899999034_" + txtFechaInicial.Text.ToString() + ".str";
                var CadenaConexion = ConfigurationManager.ConnectionStrings["CentroFormacion"].ToString();
                using (SqlConnection con = new SqlConnection(CadenaConexion))
                {
                    var Textocmd = "[Ugpp].[Usp_BuscarAjusteInformacion]";
        ...
        {
            Response.Redirect("~/Paginas/Ugpp/AjustesInformación.aspx", false);
        }
    }
}