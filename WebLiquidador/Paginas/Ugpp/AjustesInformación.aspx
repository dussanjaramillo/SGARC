<%@ Page Title="Ajustes de Información" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AjustesInformación.aspx.cs" Inherits="WebLiquidador.Paginas.Ugpp.AjustesInformación" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="auto-style8">
        <tr>
            <td><h2>Ajustes de Información</h2></td>
        </tr>
        </table>
