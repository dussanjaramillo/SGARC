...
{
    public partial class DetallesBancos : System.Web.UI.Page
    {
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string PathArchivo = "DetallesBancos_" + txtFechaInicial.Text.Trim() + "_" + txtFechaFinal.Text.Trim() + ".txt";
                var CadenaConexion = ConfigurationManager.ConnectionStrings["PlanillaConnectionString"].ToString();
                using (SqlConnection con = new SqlConnection(CadenaConexion))
                {
                    var Textocmd = "[dbo].[Usp_BuscarDetallesBancos]";
        ...
        {
            Response.Redirect("~/Paginas/DireccionGeneral/DetallesBancos.aspx", false);
        }
