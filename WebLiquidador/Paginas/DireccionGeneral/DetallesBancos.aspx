<%@ Page Title="Detalles Bancos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DetallesBancos.aspx.cs" Inherits="WebLiquidador.Paginas.DireccionGeneral.DetallesBancos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="auto-style6">
        <tr>
            <td colspan="2"><h2>Detalles Bancos</h2></td>
        </tr>
        <tr>
