...
{
    public partial class CruceBancosVsSoi : System.Web.UI.Page
    {
         ...
         protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string PathArchivo = "CruceBancosVsSoi_" + txtFechaInicial.Text.Trim() + "_" + txtFechaFinal.Text.Trim() + ".txt";
                var CadenaConexion = ConfigurationManager.ConnectionStrings["PlanillaConnectionString"].ToString();
                using (SqlConnection con = new SqlConnection(CadenaConexion))
                {
                    var Textocmd = "[dbo].[Usp_BuscarCruceBancosVsSoi]";
        ...
        {
            Response.Redirect("~/Paginas/DireccionGeneral/CruceBancosVsSoi.aspx", false);
        }
