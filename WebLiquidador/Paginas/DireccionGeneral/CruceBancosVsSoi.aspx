<%@ Page Title="Cruce Bancos Vs Soi : Soi Vs Bancos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CruceBancosVsSoi.aspx.cs" Inherits="WebLiquidador.Paginas.DireccionGeneral.CruceBancosVsSoi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="auto-style6">
        <tr>
            <td colspan="2"><h2>Cruce Bancos Vs Soi</h2></td>
        </tr>
        <tr>
