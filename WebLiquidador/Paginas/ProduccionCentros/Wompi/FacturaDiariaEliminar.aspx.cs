...
namespace WebLiquidador.Paginas.ProduccionCentros.Factura.Wompi
{
    public partial class FacturaDiariaEliminar : System.Web.UI.Page
    {
        ...
        protected void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(CadenaConexion))
            {
                try
                {
                    var Textocmd = "[CentroFormacion].[Usp_FacturaDiariaDetalleWompiDelete]";
                    ...
                    con.Close();
                    btnBorrar.Enabled = false;
                    Alerta("Listo!!!!! Prefactura Diaria Wompi Borrada");
        ...
        protected void grvProductosFacturaDiaria_DataBound(object sender, EventArgs e)
        {
            ...
            { 
              ...
              {
                  Alerta("La Prefactura Diaria Wompi No Tiene Productos para: " + Session["_NombreUsuario"].ToString());
                  btnBorrar.Enabled = false;
              }
            }
        }
