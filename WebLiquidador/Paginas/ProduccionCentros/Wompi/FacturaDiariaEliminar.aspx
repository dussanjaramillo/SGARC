<%@ Page Title="Eliminar los Productos de la Prefactura Diaria Wompi" Language="C#" MasterPageFile="~/SiteCf.Master" AutoEventWireup="true" CodeBehind="FacturaDiariaEliminar.aspx.cs" Inherits="WebLiquidador.Paginas.ProduccionCentros.Factura.Wompi.FacturaDiariaEliminar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="auto-style8">
        <tr>
            <td>
                <h2>Eliminar los Productos de la Prefactura Diaria Wompi:
    ...
    <table class="auto-style8">
        <tr>
            ...
            <td>
                <asp:SqlDataSource ID="SdsProductosFacturaDiaria" runat="server" ConnectionString="<%$ ConnectionStrings:CentroFormacion %>" SelectCommand="[CentroFormacion].[Usp_BuscarFacturaDiariaWompiRapidosDetalle_]" SelectCommandType="StoredProcedure">
                    <SelectParameters>
