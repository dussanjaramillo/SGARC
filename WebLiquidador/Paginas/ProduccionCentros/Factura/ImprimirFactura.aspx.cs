...
namespace WebLiquidador.Paginas.ProduccionCentros.Factura
{
    public partial class ImprimirFactura : System.Web.UI.Page
    {
        ...
        protected void grvFacturaXCentro_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (grvFacturaXCentro.SelectedRow.Cells[12].Text)
            {
                case "&nbsp;":
                    WTipoCliente = "";
                    break;
            ...
            Session["_FacturaAnulada"] = "Tipo Cliente: " + WTipoCliente + " - Pendiente de Pago";

            if (grvFacturaXCentro.SelectedRow.Cells[9].Text == "Si")
            {
                Session["_FacturaAnulada"] = "Tipo Cliente: " + WTipoCliente + " - Anulada";
            }
            if (grvFacturaXCentro.SelectedRow.Cells[10].Text == "Si")
            {
            ...
            //string DatosQr = Session["_Numerofactura"].ToString() + "|" + Session["_FacturaAnulada"].ToString() + "|Valor:" + hfValorTotalFactura.Value;
            ...
            //string _open = "window.open('Reportes/VisorFactura.aspx', '_newtab');";
            string _open = "window.open('Reportes/VisorFactura.aspx', '_blank');";
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            {
                Alerta("Atención, No hay Prefacturas");
                return;
            }
        ...
        protected void ExportarExcel()
        {
            ...
            grvFacturaXCentro0.Caption = "Prefacturas Disponibles";
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=" + "PrefacturasDisponibles.xls");
        ...
        protected void ExportarTxt()
        {
            try
            {
                string PathArchivo = "PrefacturasDisponibles_" + DateTime.Now.ToShortDateString().Replace("/", "_") + ".txt";
                var CadenaConexion = ConfigurationManager.ConnectionStrings["CentroFormacion"].ToString();
                using (SqlConnection con = new SqlConnection(CadenaConexion))
                {
