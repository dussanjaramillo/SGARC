<%@ Page Title="Imprimir Cotización" Language="C#" MasterPageFile="~/SiteCf.Master" AutoEventWireup="true" CodeBehind="ImprimirCotizacion.aspx.cs" Inherits="WebLiquidador.Paginas.ProduccionCentros.Factura.ImprimirCotizacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="auto-style8">
        ...
        <tr>
            <td>
                <asp:Panel ID="Panel1" runat="server" Font-Bold="True">
                    Seleccione la Cotización a Imprimir
                </asp:Panel>
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr>
            ...
            <td>
                <asp:HiddenField ID="hfValorTotalCotizacion" runat="server" />
            </td>
            <td>
