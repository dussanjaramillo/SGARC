<%@ Page Title="Documento Equivalente X Regional" Language="C#" MasterPageFile="~/SiteCf.Master" AutoEventWireup="true" CodeBehind="FacturasXRegionalXMesAñoXCentro.aspx.cs" Inherits="WebLiquidador.Paginas.ProduccionCentros.Factura.FacturasXRegionalXMesAñoXCentro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="auto-style8">
        <tr>
            <td colspan="8"><h2>Documento Equivalente Por Regional Por Mes-Año:
            ...
            <td>
                <asp:GridView ID="grvFacturasXRegionalXMesAñoXCentro" runat="server" AutoGenerateColumns="False" DataSourceID="SdsFacturasXRegionalXMesAñoXCentro" class="grvGrilla" AllowPaging="True" PageSize="15" AllowSorting="True">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="NroFacturas" HeaderText="Documento" ReadOnly="True" SortExpression="NroFacturas">
