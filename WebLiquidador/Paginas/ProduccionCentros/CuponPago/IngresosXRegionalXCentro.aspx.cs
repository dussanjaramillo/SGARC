...
{
    public partial class IngresosXRegionalXCentro : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(CadenaConexion))
                {
                    var Textocmd = "[CentroFormacion].[Usp_BuscarRecaudoXRegionalXCentro]";
                    SqlCommand cmd = new SqlCommand(Textocmd, con);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        {
            Response.Redirect("~/Paginas/ProduccionCentros/CuponPago/IngresosXRegionalXCentro.aspx", false);
        }

        protected void btnExportar_Click(object sender, EventArgs e)
        {
                grvIngresosXCentro.Visible = true;
                grvIngresosXCentro.Caption = "IngresosXRegional" + "_Desde:_" + txtFechaInicial.Text.Replace("-", "_") + "_Hasta:_" + txtFechaFinal.Text.Replace("-", "_"); 
                System.Text.StringBuilder sb = new System.Text.StringBuilder();
                ...
                Response.AddHeader("Content-Disposition", "attachment;filename=" + "IngresosXRegional" + "_Desde:_" + txtFechaInicial.Text.Replace("-", "_") + "_Hasta:_" + txtFechaFinal.Text.Replace("-", "_") + ".xls");
