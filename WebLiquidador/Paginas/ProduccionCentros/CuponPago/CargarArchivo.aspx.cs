...
namespace WebLiquidador.Paginas.ProduccionCentros.CuponPago
{
    public partial class CargarArchivo : System.Web.UI.Page
    {
        ...
        public void ImportDataFromExcel(string excelFilePath)
        {
            ...
            string ssqltable = "[CentroFormacion].[CuponPagoCargue]";
            ...
            string myexceldataquery = "Select * From [Ingresos$]";
        ...
        private void BuscarControlCarguePagos()
        {
            ...
            using (SqlConnection con = new SqlConnection(CadenaConexion))
            {
                var Textocmd = "[CentroFormacion].[Usp_BuscarControlCarguePagos]";
                SqlCommand cmd = new SqlCommand(Textocmd, con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        protected void ProcesarCuponPago()
        {
            ...
            using (SqlConnection con = new SqlConnection(CadenaConexion))
            {
                ...
                {
                    int vResultado;
                    var Textocmd = "[CentroFormacion].[Usp_ProcesarCuponPago]";
                    SqlCommand cmd = new SqlCommand(Textocmd, con);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        {
            Response.Redirect("~/Paginas/ProduccionCentros/CuponPago/CargarArchivo.aspx", false);
        }
