<%@ Page Title="Usuario" Language="C#" MasterPageFile="~/SiteCf.Master" AutoEventWireup="true" CodeBehind="Usuarios.aspx.cs" Inherits="WebLiquidador.Paginas.ProduccionCentros.Usuario.Usuarios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <table class="auto-style1" style="width: 85%">
                    <tr>
                        <td colspan="8" style="background-color: #546E96">
                            <asp:Label ID="LblError" runat="server" ForeColor="White" Font-Bold="False"></asp:Label>
                            <br />
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style3">Codigo<asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtCodigoUsuario" ErrorMessage=": Requerido" ForeColor="Maroon" Font-Bold="True" ValidationGroup="btnBuscar"></asp:RequiredFieldValidator>
                            <br />
                        </td>
                        <td class="auto-style3">Nombre<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtNombreUsuario" ErrorMessage=": Requerido" ForeColor="Maroon" Font-Bold="True" ValidationGroup="btnGuardar"></asp:RequiredFieldValidator>
                        </td>
                        <td class="auto-style3">Regional<asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="ddlRegional" ErrorMessage=": Requerido" Font-Bold="True" ForeColor="Maroon" InitialValue="-1" ValidationGroup="btnGuardar"></asp:RequiredFieldValidator>
                        </td>
                        <td class="auto-style3">Centro<asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="Maroon" Text=": Requerido" Visible="False"></asp:Label>
                        </td>
                        <td class="auto-style3">Cargo<asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ControlToValidate="ddlRolUsuario" ErrorMessage=": Requerido" Font-Bold="True" ForeColor="Maroon" InitialValue="-1" ValidationGroup="btnGuardar"></asp:RequiredFieldValidator>
                            <br />
                        </td>
                        <td class="auto-style3">Rol<asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ControlToValidate="ddlRolUsuario" ErrorMessage=": Requerido" Font-Bold="True" ForeColor="Maroon" InitialValue="-1" ValidationGroup="btnGuardar"></asp:RequiredFieldValidator>
                        </td>
