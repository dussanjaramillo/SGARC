<%@ Page Title="Apoyo Emergencia Económica" Language="C#" MasterPageFile="~/SiteCf.Master" AutoEventWireup="true" CodeBehind="Factura.aspx.cs" Inherits="WebLiquidador.Paginas.ProduccionCentros.InventarioAyudas.Factura" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="auto-style6">
        <tr>
            <td colspan="7">
                <h2>Generar Apoyo Emergencia Económica
        ...
        <tr>
            ...
            <td class="auto-style10">Departamento<asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ErrorMessage=": Requerido" Font-Bold="True" ForeColor="Maroon" ValidationGroup="btnAgregar" ControlToValidate="ddlDepartamento" InitialValue="-1" SetFocusOnError="True"></asp:RequiredFieldValidator>
            </td>
        ...
        <tr>
            <td class="auto-style10">
                <asp:TextBox ID="txtIdentificacion" PlaceHolder="Identificación" runat="server" Width="170px" MaxLength="16"></asp:TextBox>
            ...
            <td class="auto-style10">
                <asp:TextBox ID="txtNombre" PlaceHolder="Nombre del Aprendiz" runat="server" Width="170px" MaxLength="100"></asp:TextBox>
            ...
            <td class="auto-style10">
                <asp:TextBox ID="txtDireccion" PlaceHolder="Dirección" runat="server" Width="170px" MaxLength="100"></asp:TextBox>
            ...
            <td class="auto-style10">
                <asp:TextBox ID="txtTelefono" PlaceHolder="Teléfono" runat="server" Width="170px" MaxLength="100"></asp:TextBox>
                <Ajax:FilteredTextBoxExtender ID="txtTelefono_FilteredTextBoxExtender" runat="server" BehaviorID="txtTelefono_FilteredTextBoxExtender" FilterType="Custom, Numbers" TargetControlID="txtTelefono" ValidChars="- " />
            </td>
            <td class="auto-style10">
        ...
        <tr>
            <td class="auto-style22" colspan="3">
                Persona que Entrega el Apoyo<br />
                <asp:TextBox ID="txtContacto" PlaceHolder="Contacto" runat="server" MaxLength="100" Width="510px"></asp:TextBox>
            </td>
            <td class="auto-style22" colspan="3">
                Referencia o Descripción Adicional<br />
                <asp:TextBox ID="txtReferencia" PlaceHolder="Referencia" runat="server" MaxLength="100" Width="510px"></asp:TextBox>
            </td>
            <td class="auto-style22">
                &nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td>Precio Apoyo<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPrecio" ErrorMessage=": Requerido" Font-Bold="True" ForeColor="Maroon" ValidationGroup="btnAgregar" SetFocusOnError="True"></asp:RequiredFieldValidator>
            </td>
            <td>Cantidad Apoyo<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtCantidad" ErrorMessage=": Requerido" Font-Bold="True" ForeColor="Maroon" ValidationGroup="btnAgregar" SetFocusOnError="True"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            ...
            <td class="auto-style20">
                <asp:TextBox ID="txtCantidadExistencia" runat="server" Width="170px" Enabled="False" Font-Bold="True" ForeColor="Maroon"></asp:TextBox>
            </td>
            <td class="auto-style10">
            ...
            <td class="auto-style9">
                <asp:DropDownList ID="ddlUnidadMedida" runat="server" DataSourceID="SdsUnidadMedida" DataTextField="NombreUnidadMedida" DataValueField="IdUnidadMedida" OnDataBound="ddlUnidadMedida_DataBound" Width="170px" Enabled="False" OnSelectedIndexChanged="ddlUnidadMedida_SelectedIndexChanged" AutoPostBack="True" Font-Bold="True" ForeColor="Maroon">
                </asp:DropDownList>
            </td>
            <td>
                <asp:TextBox ID="txtPrecio" PlaceHolder="Precio Apoyo" runat="server" Width="170px" Enabled="False"></asp:TextBox>
            ...
            <td>
                <asp:TextBox ID="txtCantidad" PlaceHolder="Cantidad Apoyo" runat="server" Width="170px" MaxLength="6" Enabled="False"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:Panel ID="Panel3" runat="server">
                    Recuerde: Cuando Usted Guarde la Ayuda, ésta no podrá ser modificada
                </asp:Panel>
            </td>
        </tr>
    </table>
    <table class="auto-style6">
        <tr>
            <td colspan="3">
                <asp:Panel ID="Panel6" runat="server">
                    Identificación del Aprendiz, diligencie éste campo (Sin Dígito de Verificación) Por Favor.</asp:Panel>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:SqlDataSource ID="SdsProductosXCentrro" runat="server" ConnectionString="<%$ ConnectionStrings:LiquidadorConnectionString %>" SelectCommand="[CentroFormacion].[Usp_BuscarProductosInventarioAyudas]" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter Name="IdCentroFormacion" SessionField="_IdCentroFormacion" Type="Int32" />
                    </SelectParameters>
                </asp:SqlDataSource>
