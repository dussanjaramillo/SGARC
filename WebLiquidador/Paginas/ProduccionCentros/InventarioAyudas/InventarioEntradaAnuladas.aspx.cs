...
{
    public partial class InventarioEntradaAnuladas : System.Web.UI.Page
    {
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            grvInventarioVentas0.Caption = "InventarioMovimientosEntradaEmergenciaEconómica_" + Session["_NombreCentroFormacion"].ToString() + "_Desde:_" + txtFechaInicial.Text.Replace("-", "_") + "_Hasta:_" + txtFechaFinal.Text.Replace("-", "_");
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=" + "InventarioMovimientosEntradas_" + Session["_NombreCentroFormacion"].ToString() + "_Desde:_" + txtFechaInicial.Text.Replace("-", "_") + "_Hasta:_" + txtFechaFinal.Text.Replace("-", "_") + ".xls");
        ...
        {
            Response.Redirect("~/Paginas/ProduccionCentros/InventarioAyudas/InventarioEntradaAnuladas.aspx", false);
        }
