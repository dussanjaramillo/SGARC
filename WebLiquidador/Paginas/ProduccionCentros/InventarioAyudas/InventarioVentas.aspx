<%@ Page Title="Inventario Movimientos - Apoyo Emergencia Económica" Language="C#" MasterPageFile="~/SiteCf.Master" AutoEventWireup="true" CodeBehind="InventarioVentas.aspx.cs" Inherits="WebLiquidador.Paginas.ProduccionCentros.InventarioAyudas.InventarioVentas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="auto-style8">
        <tr>
            <td>
                <h2>Inventario Movimientos - Apoyo Emergencia Económica:
    ...
    <table class="auto-style8">
            ...
            <td colspan="5">
                <asp:GridView ID="grvInventarioVentas" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SdsDetalleProductosXFacturaXCentro" PageSize="15">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ValorTotal" DataFormatString="{0:N0}" HeaderText="ValorTotal" ReadOnly="True" SortExpression="ValorTotal">
                        <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="NombreUnidadMedida" HeaderText="Medida" SortExpression="NombreUnidadMedida" />
                        <asp:BoundField DataField="NombreMotivoAnulacionFactura" HeaderText="MotivoAnulacion" SortExpression="NombreMotivoAnulacionFactura" />
                    </Columns>
            ...
            <td class="auto-style9" colspan="5">
                ...
                <asp:GridView ID="grvInventarioVentas0" runat="server" AutoGenerateColumns="False" PageSize="15" Visible="False" Width="531px" class="grvGrilla" Caption="Inventario Movimientos - Apoyo Emergencia Económica" DataSourceID="SdsDetalleProductosXFacturaXCentro">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ValorTotal" HeaderText="ValorTotal" ReadOnly="True" SortExpression="ValorTotal" />
                        <asp:BoundField DataField="NombreUnidadMedida" HeaderText="Medida" SortExpression="NombreUnidadMedida" />
                        <asp:BoundField DataField="NombreMotivoAnulacionFactura" HeaderText="MotivoAnulacion" SortExpression="NombreMotivoAnulacionFactura" />
                    </Columns>
                    <FooterStyle BackColor="White" ForeColor="#000066" />
        ...
        <tr>
            ...
            <td>
                <asp:SqlDataSource ID="SdsDetalleProductosXFacturaXCentro" runat="server" ConnectionString="<%$ ConnectionStrings:LiquidadorConnectionString %>" SelectCommand="[CentroFormacion].[Usp_InventarioProductosXFacturaAyudasXCentro]" SelectCommandType="StoredProcedure">
                    <SelectParameters>
