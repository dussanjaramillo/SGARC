...
namespace WebLiquidador.Paginas.ProduccionCentros.InventarioAyudas
{
    public partial class InventarioVentas : System.Web.UI.Page
    {
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            grvInventarioVentas0.Caption = "InventarioMovimientosApoyoEmergenciaEconómica_" + Session["_NombreCentroFormacion"].ToString() + "_Desde:_" + txtFechaInicial.Text.Replace("-", "_") + "_Hasta:_" + txtFechaFinal.Text.Replace("-", "_");
        ...
        {
            Response.Redirect("~/Paginas/ProduccionCentros/InventarioAyudas/InventarioVentas.aspx", false);
        }
