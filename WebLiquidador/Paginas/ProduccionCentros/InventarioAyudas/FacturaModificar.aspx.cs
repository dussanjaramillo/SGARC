...
namespace WebLiquidador.Paginas.ProduccionCentros.InventarioAyudas
{
    public partial class FacturaModificar : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/Paginas/ProduccionCentros/InventarioAyudas/FacturaModificar.aspx", false);
        }
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(CadenaConexion))
            {
                try
                {
                    var Textocmd = "[CentroFormacion].[Usp_FacturaUpdateAyudas]";
            ...
            grvFacturaXCentro.SelectedIndex = -1;
            Alerta("Atención!!!!:" + Session["_NombreUsuario"].ToString() + " Usted debe Imprimir de Nuevo el Apoyo");
        }
        ...
        protected void grvFacturaXCentro_DataBound(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    Alerta("No Hay Apoyos para su Centro");
                    return;
                }
            }
        }
        ...
        protected void grvFacturaXCentro_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                grvFacturaXCentro.SelectedIndex = -1;
                Alerta("Error: Lo Siento éste Apoyo no se puede Modificar");
                return;
            }
        ...
        private void Buscarfactura(Int64 NumeroFactura)
        {
            ...
            using (SqlConnection con = new SqlConnection(CadenaConexion))
            {
                var Textocmd = "[CentroFormacion].[Usp_BuscarFacturaXNumeroFacturaAyudas_]";
                SqlCommand cmd = new SqlCommand(Textocmd, con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
