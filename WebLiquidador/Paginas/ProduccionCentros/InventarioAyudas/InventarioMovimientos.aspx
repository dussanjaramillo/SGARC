<%@ Page Title="Inventario Movimientos - Entradas - Apoyo Emergencia Económica" Language="C#" MasterPageFile="~/SiteCf.Master" AutoEventWireup="true" CodeBehind="InventarioMovimientos.aspx.cs" Inherits="WebLiquidador.Paginas.ProduccionCentros.InventarioAyudas.InventarioMovimientos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="auto-style8">
        <tr>
            <td>
                <h2>Inventario Movimientos - Entradas Vs Apoyo Emergencia Económica
    ...
    <table class="auto-style8">
        <tr>
            <td colspan="2">
                <asp:GridView ID="grvInventarioMovimientos" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" Width="100%" BorderStyle="None" CellPadding="3" DataSourceID="SdsInventarioMovimientos" ForeColor="#333333">
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="grvInventarioMovimientos0" runat="server" AutoGenerateColumns="False" PageSize="15" Visible="False" Width="531px" class="grvGrilla" Caption="Inventario Movimientos - Entradas - Apoyos" DataSourceID="SdsInventarioMovimientos">
        ...
        <tr>
            <td>
                <asp:SqlDataSource ID="SdsInventarioMovimientos" runat="server" ConnectionString="<%$ ConnectionStrings:LiquidadorConnectionString %>" SelectCommand="[CentroFormacion].[Usp_BuscarInventarioMovimientosAyudas]" SelectCommandType="StoredProcedure">
                    <SelectParameters>
