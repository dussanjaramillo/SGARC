...
namespace WebLiquidador.Paginas.ProduccionCentros.Estadisticas
{
    public partial class FacturasXRegionalXMesAñoXCentro : System.Web.UI.Page
    {
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            grvFacturasXRegionalXMesAñoXCentro0.Caption = "DocumentoEquivalnteXRegionalXMesAñoXCentro_" + lblEstado.Text;
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=" + "DocumentoEquivalenteXRegionalXMesAñoXCentro_" + lblEstado.Text + ".xls");
