...
namespace WebLiquidador.Paginas.ProduccionCentros.Inventario
{
    public partial class InventarioMovimientos : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/Paginas/ProduccionCentros/Inventario/InventarioMovimientos.aspx", false);
        }
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=" + "InventarioMovimientos_" + Session["_NombreCentroFormacion"].ToString() + "_Desde:_" + txtFechaInicial.Text.Replace("-", "_") + "_Hasta:_" + txtFechaFinal.Text.Replace("-", "_") + ".xls");
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Paginas/ProduccionCentros/Inventario/Reportes/VisorInventarioMovimientosXCentro.aspx", false);
        }
    }
}