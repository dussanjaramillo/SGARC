<%@ Page Title="Inventario Ventas - Movimientos" Language="C#" MasterPageFile="~/SiteCf.Master" AutoEventWireup="true" CodeBehind="InventarioVentas.aspx.cs" Inherits="WebLiquidador.Paginas.ProduccionCentros.Inventario.InventarioVentas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="auto-style8">
        <tr>
            <td>
                <h2>Inventario Movimientos - Ventas :
    ...
    <table class="auto-style8">
        <tr>
            <td colspan="5">
                <asp:GridView ID="grvInventarioVentas" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SdsDetalleProductosXFacturaXCentro">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CantidadVendida" HeaderText="CntVendida" SortExpression="CantidadVendida" />
        ...
        <tr>
            <td class="auto-style9" colspan="5">
                ...
                <asp:GridView ID="grvInventarioVentas0" runat="server" AutoGenerateColumns="False" PageSize="15" Visible="False" Width="531px" class="grvGrilla" Caption="Inventario Movimientos - Ventas" DataSourceID="SdsDetalleProductosXFacturaXCentro">
        ...
        <tr>
            ...
            <td>
                <asp:SqlDataSource ID="SdsDetalleProductosXFacturaXCentro" runat="server" ConnectionString="<%$ ConnectionStrings:LiquidadorConnectionString %>" SelectCommand="[CentroFormacion].[Usp_InventarioProductosXFacturaXCentro]" SelectCommandType="StoredProcedure">
                    <SelectParameters>
