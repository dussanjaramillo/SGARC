<%@ Page Title="Movimiento de Productos" Language="C#" MasterPageFile="~/SiteCf.Master" AutoEventWireup="true" CodeBehind="InventarioProductos.aspx.cs" Inherits="WebLiquidador.Paginas.ProduccionCentros.Inventario.InventarioProductos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="auto-style8">
        <tr>
            <td colspan="3"><h2>Inventario de Productos:
    ...
    <table class="auto-style8">
        <tr>
            <td colspan="8">
                ...
                <asp:GridView ID="grvMovimientos0" runat="server" DataSourceID="SdsInventarioProductos" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" class="grvGrilla" CellPadding="3" Visible="False" Caption="Inventario de Productos">
                     <AlternatingRowStyle BackColor="#DCDCDC" />
                     <Columns>
                        <asp:BoundField DataField="CodigoCentroFormacion" HeaderText="Codigo" SortExpression="CodigoCentroFormacion" />
                        <asp:BoundField DataField="NombreCentroFormacion" HeaderText="CentroFormacion" SortExpression="NombreCentroFormacion" />
