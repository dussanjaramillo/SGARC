...
namespace WebLiquidador.Paginas.ProduccionCentros.Siif
{
    public partial class CargarArchivo : System.Web.UI.Page
    {
        ...
        public void ImportDataFromExcel(string excelFilePath)
        {
            ...
            string ssqltable = "[CentroFormacion].[CarguePagosFacturaSiif]";
            ...
            string myexceldataquery = "Select * From [PagoSiif$]";
        ...
        private void ControlArchivo(int Registros)
        {
            ...
            using (SqlConnection con = new SqlConnection(CadenaConexion))
            {
                ...
                {
                    int vResultado;
                    var Textocmd = "[CentroFormacion].[Usp_ControlCarguePagosSiifInsert]";
        ...
        private void BuscarControlCarguePagos()
        {
            ...
            using (SqlConnection con = new SqlConnection(CadenaConexion))
            {
                var Textocmd = "[CentroFormacion].[Usp_BuscarControlCarguePagosSiif]";
                SqlCommand cmd = new SqlCommand(Textocmd, con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        protected void ProcesarCuponPago()
        {
            var CadenaConexion = ConfigurationManager.ConnectionStrings["CentroFormacion"].ToString();
            using (SqlConnection con = new SqlConnection(CadenaConexion))
            {
                ...
                {
                    int vResultado;
                    var Textocmd = "[CentroFormacion].[Usp_ProcesarCuponPagoSiif]";
                    SqlCommand cmd = new SqlCommand(Textocmd, con);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        {
            Response.Redirect("~/Paginas/ProduccionCentros/Siif/CargarArchivo.aspx", false);
        }
    }
}