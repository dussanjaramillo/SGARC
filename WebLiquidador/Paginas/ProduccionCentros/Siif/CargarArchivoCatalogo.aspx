<%@ Page Title="Cargar Archivo Catálogo Siif" Language="C#" MasterPageFile="~/SiteCf.Master" AutoEventWireup="true" CodeBehind="CargarArchivoCatalogo.aspx.cs" Inherits="WebLiquidador.Paginas.ProduccionCentros.Siif.CargarArchivoCatalogo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="auto-style6">
        <tr>
            <td colspan="2"><h2>Cargar Archivo Catálogo - Siif Nación</h2></td>
        </tr>
        <tr>
...
<%--                <asp:FileUpload ID="FuCargarArchivo" runat="server" accept="application/vnd.ms-excel" Width="481px"  />--%>
                <asp:FileUpload ID="FuCargarArchivo" runat="server" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" Width="481px"  />
            </td>
