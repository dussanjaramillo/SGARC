<%@ Page Title="Conciliación Siif - Sgarc A Plazos" Language="C#" MasterPageFile="~/SiteCf.Master" AutoEventWireup="true" CodeBehind="ConciliaciónSiifSgarcAPlazos.aspx.cs" Inherits="WebLiquidador.Paginas.ProduccionCentros.Siif.Facturas.ConciliaciónSiifSgarcAPlazos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="auto-style12">
        <tr>
            <td><h2>Conciliación Siif - Sgarc A Plazos:&nbsp;
...
<table class="auto-style8">
        <tr>
            <td>
                <asp:SqlDataSource ID="SdsFacturaElectronicas" runat="server" ConnectionString="<%$ ConnectionStrings:CentroFormacion %>" SelectCommand="[CentroFormacion].[Usp_BuscarFacturaElectronicaSiifXTipoFacturaXCentro_]" SelectCommandType="StoredProcedure">
                    <SelectParameters>
