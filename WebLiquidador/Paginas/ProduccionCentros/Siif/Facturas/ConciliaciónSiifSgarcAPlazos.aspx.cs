...
{
    public partial class ConciliaciónSiifSgarcAPlazos : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/Paginas/ProduccionCentros/Siif/Facturas/ConciliaciónSiifSgarcAPlazos.aspx", false);
        }
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            {
                Alerta("Atención, No Hay Conciliación Siif - Sgarc A Plazos");
                return;
            }
        ...
        protected void ExportarExcel()
        {
            ...
            GridView2.Caption = "Conciliación_Siif_Sgarc_APlazos_" + Session["_NombreCentroFormacion"].ToString(); 
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=" + "ConciliacionSiif_Sgarc_APlazos.xls");
        ...
        protected void ExportarTxt()
        {
            try
            {
                string PathArchivo = "ConciliaciónSiif_Sgarc_APlazos" + Session["_NombreCentroFormacion"].ToString()+DateTime.Now.ToShortDateString().Replace("/", "_") + ".txt";
                var CadenaConexion = ConfigurationManager.ConnectionStrings["CentroFormacion"].ToString();
                using (SqlConnection con = new SqlConnection(CadenaConexion))
                {
                    var Textocmd = "[CentroFormacion].[Usp_BuscarFacturaElectronicaSiifXTipoFacturaXCentro_]";
